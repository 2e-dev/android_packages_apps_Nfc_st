...
public class NfcService implements DeviceHostListener {
    ...
    final class StExtrasService extends INfcAdapterStExtensions.Stub {
        ...
        public void seteSeReaderMode(boolean start) {
            Log.i(TAG, "seteSeReaderMode() - start: " + start);

            if (isNfcEnabled() == false) {
                Log.e(TAG, "seteSeReaderMode() - NFC is not enabled, ignore");
                return;
            }
            ...
            if (start) {
                // Start an empty pollig loop
                mNfcSettingsAdapterService.setModeFlag(
                        NfcSettingsAdapter.MODE_READER, NfcSettingsAdapter.FLAG_OFF);
                mNfcSettingsAdapterService.setModeFlag(
                        NfcSettingsAdapter.MODE_P2P, NfcSettingsAdapter.FLAG_OFF);
                ...
                // Start an empty pollig loop
                mNfcSettingsAdapterService.setModeFlag(
                        NfcSettingsAdapter.MODE_READER, NfcSettingsAdapter.FLAG_ON);
                mNfcSettingsAdapterService.setModeFlag(
                        NfcSettingsAdapter.MODE_P2P, NfcSettingsAdapter.FLAG_ON);
